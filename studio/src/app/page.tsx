...
import { ContractForm, type ContractFormState } from "@/components/contract-form";
...
export default function Home() {
  ...
  const handleFormDataChange = (data: ContractFormState) => {
    ...
    <div className="container mx-auto px-4 py-8 flex-grow flex">
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 w-full">
        ...
        <div className="lg:col-span-3 overflow-y-auto h-[calc(100vh-10rem)] pr-4">
          <h2 className="text-2xl font-headline font-semibold mb-4 no-print sticky top-0 bg-background z-10 pt-2 pb-2">Vista Previa del Contrato</h2>
          <ContractPreview
